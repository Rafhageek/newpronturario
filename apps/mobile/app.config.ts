...
const config: ExpoConfig = {
  ...
  plugins: [
    ...
    // Sem isso, tocar em "Permitir" derruba o app. Pacote de workspace (não
    // arquivo local por caminho) — ver comentário em index.js do pacote.
    '@hubpatients/eas-plugin-health-connect',
