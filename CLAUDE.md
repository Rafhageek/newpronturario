# Projeto Prontuário — Instruções para o Claude Code

## Regra principal: SEMPRE consultar as skills

Antes de qualquer tarefa de desenvolvimento, **consulte as skills instaladas em `.claude/skills/`** e use a(s) relevante(s). Não improvise quando existe uma skill que cobre o assunto.

Mapa rápido (inventário completo em [.claude/skills/README.md](.claude/skills/README.md)):
